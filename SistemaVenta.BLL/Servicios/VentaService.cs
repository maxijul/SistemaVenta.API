...
namespace SistemaVenta.BLL.Servicios
{
    public class VentaService: IVentaService
    {
        ...
        public async Task<List<VentaDTO>> Historial(string bucarPor, string numeroVenta, string fechaInicio, string fechaFin)
        {
            ...
            try
            {
                if(bucarPor == "fecha")
                {
                    ...
                    ListaResultado = await query.Where(v => v.FechaRegistro.Value.Date >= 
                    fech_Inicio.Date && v.FechaRegistro.Value.Date <= fech_Fin.Date).Include(dv => dv.DetalleVenta)
